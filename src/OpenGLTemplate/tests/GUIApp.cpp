...
bool GUIApp::update(GLdouble a_deltaTime)
{
...
bool GUIApp::fixedUpdate(GLdouble a_deltaTime)
{
	return true;
}

bool GUIApp::draw(GLdouble a_deltaTime)
{
